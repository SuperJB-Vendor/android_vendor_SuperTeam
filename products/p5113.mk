...
PRODUCT_COPY_FILES += \
    vendor/SuperTeam/prebuilt/bootanimation/bootanimation_1280_800.zip:system/media/bootanimation.zip

PRODUCT_PACKAGE_OVERLAYS += vendor/SuperTeam/overlay/espressowifi

PRODUCT_PACKAGES += \
    NovaLauncher

# Inherit some common CM stuff.
$(call inherit-product, vendor/SuperTeam/configs/common_tablet.mk)
